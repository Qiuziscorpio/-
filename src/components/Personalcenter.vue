<template>
  <div class="verticalheight">
    ...
    <router-link class="item distancetop" :to="{name:'store',params:{type:'Product',id:'store'}}" tag="div">
      <div class="tit">
        <i class="icon iconfont icon-xuanshangpin"></i> 商品收藏
      </div>
      <div class="open">
    ...
    <router-link class="item" :to="{name:'store',params:{type:'Supplier',id:'store'}}" tag="div">
      <div class="tit">
        <i class="icon iconfont icon-shangjia"></i> 店铺收藏
      </div>
      <div class="open">
        <i class="icon iconfont icon-you"></i>
      </div>
    ...
    <router-link class="item distancetop" :to="{name:'documents'}" tag="div">
      <div class="tit">
        <i class="icon iconfont icon-waibudanju"></i> 外部单据
      </div>
      <div class="open">
        <i class="icon iconfont icon-you"></i>
      </div>
    ...
    <router-link class="item distancetop" :to="{name: 'about'}" tag="div">
      <div class="tit">
        <i class="icon iconfont icon-guanyu"></i> 关于蚁管家
      </div>
      <div class="open">
        <i class="icon iconfont icon-you"></i>
      </div>
